...
{
    public BasicAuthAlfrescoConnectionFactory(ConnectionDetails connectionData)
    {
        super("alfresco", new BasicAuthServiceProvider(connectionData), new AlfrescoAdapter());
    }
