...
public abstract class AbstractAlfrescoTemplate implements Alfresco
{
    ...
    public AbstractAlfrescoTemplate(String repoBaseUrl, String syncBaseUrl,
            String publicApiServletName, String serviceServletName)
    {
        ...
        this.ROOT_ATOMPUB_URL = new PublicApiServiceUrl(repoBaseUrl,
                "cmis/versions/1.0/atom");
        this.ATOMPUB_1_0_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/cmis/versions/1.0/atom");
        this.ATOMPUB_1_1_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/cmis/versions/1.1/atom");
        this.BROWSER_BINDING_1_1_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/cmis/versions/1.1/browser");
        this.NETWORKS_URL = new PublicApiNetworkUrl(repoBaseUrl, "");
        this.NETWORK_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/networks/{network}");
        this.SITES_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/sites");
        this.SITE_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/sites/{site}");
        this.CONTAINERS_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/sites/{site}/containers");
        this.CONTAINER_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/sites/{site}/containers/{container}");
        this.MEMBERS_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/sites/{site}/members");
        this.MEMBER_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/sites/{site}/members/{member}");
        this.PEOPLE_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}");
        this.PEOPLE_SITES_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/sites");
        this.PEOPLE_SITE_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/sites/{site}");
        this.PEOPLE_FAVORITES_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/favorites");
        this.PEOPLE_FAVORITE_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/favorites/{targetGuid}");
        this.PEOPLE_FAVORITE_SITES_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/favorite-sites");
        this.PEOPLE_PREFERENCES_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/preferences");
        this.PEOPLE_PREFERENCE_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/preferences/{preference}");
        this.PEOPLE_NETWORKS_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/networks");
        this.PEOPLE_NETWORK_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/networks/{network}");
        this.PEOPLE_ACTIVITIES_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/activities");
        this.TAGS_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/tags");
        this.TAG_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/tags/{tag}");
        this.NODE_COMMENTS_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/nodes/{node}/comments");
        this.NODE_COMMENT_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/nodes/{node}/comments/{comment}");
        this.NODE_TAGS_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/nodes/{node}/tags/");
        this.NODE_TAG_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/nodes/{node}/tags/{tag}");
        this.NODE_RATINGS_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/nodes/{node}/ratings");
        this.NODE_RATING_URL = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/public/alfresco/versions/1/nodes/{node}/ratings/{rating}");
        this.PEOPLE_SITE_MEMBERSHIP_REQUESTS_URL = new PublicApiNetworkUrl(
                repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/site-membership-requests");
        this.PEOPLE_SITE_MEMBERSHIP_REQUEST_URL = new PublicApiNetworkUrl(
                repoBaseUrl,
                "{network}/public/alfresco/versions/1/people/{person}/site-membership-requests/{site}");
        this.CREATE_SITE_URL = new PublicApiServiceUrl(repoBaseUrl, "api/sites");
        this.DELETE_SITE_URL = new PublicApiServiceUrl(repoBaseUrl,
                "api/sites/{siteId}");
        this.ADM_CREATE_MULTI_URL = new PublicApiServiceUrl(repoBaseUrl,
                "remoteadm/createmulti");
        this.ACCESS_DOC_LIB_URL = new PublicApiServiceUrl(repoBaseUrl,
                "slingshot/doclib2/doclist/all/site/<siteId>/documentLibrary/");
        this.BASE_NODE_URL = new PublicApiNetworkUrl(repoBaseUrl, "{network}"
                + VERSION + "nodes/{node}/");
        this.REGISTER_USER_URL = new PublicApiServiceUrl(repoBaseUrl,
                "internal/cloud/accounts/signupqueue");
        this.ACTIVATE_USER_URL = new PublicApiServiceUrl(repoBaseUrl,
                "internal/cloud/account-activations");
        this.SUBSCRIBERS_PATH = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/private/alfresco/versions/1/subscribers");
        this.SUBSCRIBER_PATH = new PublicApiNetworkUrl(repoBaseUrl,
                "{network}/private/alfresco/versions/1/subscribers/{subscriberId}");
        this.SUBSCRIPTIONS_PATH = new PublicApiNetworkUrl(
                repoBaseUrl,
                "{network}/private/alfresco/versions/1/subscribers/{subscriberId}/subscriptions");
        this.SUBSCRIPTION_PATH = new PublicApiNetworkUrl(
                repoBaseUrl,
                "{network}/private/alfresco/versions/1/subscribers/{subscriberId}/subscriptions/{subscriptionId}");
        this.SYNCS_PATH = new PublicApiNetworkUrl(
                syncBaseUrl,
                "{network}/private/alfresco/versions/1/subscribers/{subscriberId}/subscriptions/{subscriptionId}/sync");
        this.SYNC_PATH = new PublicApiNetworkUrl(
                syncBaseUrl,
                "{network}/private/alfresco/versions/1/subscribers/{subscriberId}/subscriptions/{subscriptionId}/sync/{syncId}");
        this.METRICS = new PublicApiNetworkUrl(syncBaseUrl,
                "{network}/private/alfresco/versions/1/metrics");
        this.CREATE_PERSON_URL = new PublicApiServiceUrl(repoBaseUrl,
                "api/people");

        SimpleModule module = new SimpleModule("", new Version(1, 0, 0, null));
        module.addDeserializer(FavouriteTarget.class,
                new FavouriteTargetDeserializer());
        ...
        cmisServiceUrls.put(new CMISEndpoint(BindingType.ATOMPUB,
                CmisVersion.CMIS_1_0), ATOMPUB_1_0_URL);
        cmisServiceUrls.put(new CMISEndpoint(BindingType.ATOMPUB,
                CmisVersion.CMIS_1_1), ATOMPUB_1_1_URL);
        cmisServiceUrls.put(new CMISEndpoint(BindingType.BROWSER,
                CmisVersion.CMIS_1_1), BROWSER_BINDING_1_1_URL);
    }
    ...
    //
    // @Override
    // public void serialize(ObjectData object, JsonGenerator jgen,
    ...
    // private static class FavouriteTargetDeserializer extends
    // JsonDeserializer<FavouriteTarget>
    // {
    ...
    //
    // @Override
    // public FavouriteTarget deserialize(JsonParser jp, DeserializationContext
    // ctxt)
    ...
    // ctxt.getDeserializerProvider().findValueDeserializer(ctxt.getConfig(), t,
    // p);
    //
    ...
    // {
    // throw new
    // IllegalArgumentException("Target body is invalid for target type");
    // }
    // }
    ...
    // else
    // {
    // throw new IOException("Unable to deserialize favourite: " +
    // curr.asString());
    // }
    // }
    // }

    // private static class NodeDeserializer extends
    ...
    public static class FavouriteTargetDeserializer extends
            JsonDeserializer<FavouriteTarget>
    {
        @Override
        public FavouriteTarget deserialize(JsonParser jp,
                ...
                while (jp.nextToken() != JsonToken.END_OBJECT)
                {
                    ...
                    if ("SITE".equals(fieldname.toUpperCase()))
                    {
                        ...
                        try
                        {
                            JavaType t = SimpleType.construct(Site.class);
                            BeanProperty p = new Std("", t, null, null);
                            JsonDeserializer<?> siteDeserializer = ctxt
                                    .getDeserializerProvider()
                                    .findValueDeserializer(ctxt.getConfig(), t,
                                            p);

                            Site site = (Site) siteDeserializer.deserialize(jp,
                                    ctxt);
                            target = new SiteFavouriteTarget(site);
                        }
                        catch (JsonMappingException e)
                    ...
                    else if ("FILE".equals(fieldname.toUpperCase()))
                    {
                        ...
                        try
                        {
                            JavaType t = SimpleType
                                    .construct(org.springframework.social.alfresco.api.entities.Document.class);
                            BeanProperty p = new Std("", t, null, null);
                            JsonDeserializer<?> documentDeserializer = ctxt
                                    .getDeserializerProvider()
                                    .findValueDeserializer(ctxt.getConfig(), t,
                                            p);

                            org.springframework.social.alfresco.api.entities.Document document = (org.springframework.social.alfresco.api.entities.Document) documentDeserializer
                                    .deserialize(jp, ctxt);
                    ...
                    else if ("FOLDER".equals(fieldname.toUpperCase()))
                    {
                        ...
                        {
                            JavaType t = SimpleType
                                    .construct(org.springframework.social.alfresco.api.entities.Folder.class);
                            BeanProperty p = new Std("", t, null, null);
                            JsonDeserializer<?> folderDeserializer = ctxt
                                    .getDeserializerProvider()
                                    .findValueDeserializer(ctxt.getConfig(), t,
                                            p);

                            org.springframework.social.alfresco.api.entities.Folder folder = (org.springframework.social.alfresco.api.entities.Folder) folderDeserializer
                                    .deserialize(jp, ctxt);
            ...
            CMISEndpoint cmisEndpoint)
    {
        ...
        Session session = sessionFactory.createSession(parameters,
                objectFactory, authenticationProvider, null);
    ...
    public List<Repository> getCMISNetworks()
    {
        ...
        parameters.put(SessionParameter.ATOMPUB_URL,
                ROOT_ATOMPUB_URL.getUrl(null));
        parameters.put(SessionParameter.BINDING_TYPE,
                BindingType.ATOMPUB.value());

        return sessionFactory.getRepositories(parameters, null,
    ...
    protected void configureRestTemplate()
    {
        repoRestTemplate.setErrorHandler(new ResponseErrorHandler()
        {
            ...
            private String getResponseBody(ClientHttpResponse response)
            {
                ...
                Charset charset = contentType != null ? contentType
    ...
    public Network getNetwork(String networkId) throws JsonParseException,
            JsonMappingException, IOException
    {
        Map<String, String> vars = Collections.singletonMap(
                TemplateParams.NETWORK, networkId);
        String response = getRepoRestTemplate().getForObject(
                NETWORK_URL.getUrl(networkId), String.class, vars);
        log.debug("getNetwork: " + response);
        Response<Network> n = mapper.readValue(response,
                entryResponseType(Network.class));
        return n.getEntry();
    }

    public AlfrescoList<Network> getNetworks() throws JsonParseException,
            JsonMappingException, IOException
    {
    ...
    {
        String response = getRepoRestTemplate().getForObject(
                NETWORKS_URL.getUrl(null) + generateQueryString(parameters),
                String.class);
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                SITE_URL.getUrl(networkId), String.class, vars);
        log.debug("getSite: " + response);
        Response<Site> s = mapper.readValue(response,
                entryResponseType(Site.class));
        return s.getEntry();
    ...
    public AlfrescoList<Site> getSites(String networkId,
            Map<String, String> parameters) throws JsonParseException,
            JsonMappingException, IOException
    {
        Map<String, String> vars = Collections.singletonMap(
                TemplateParams.NETWORK, networkId);
        String response = getRepoRestTemplate().getForObject(
                SITES_URL.getUrl(networkId) + generateQueryString(parameters),
                String.class, vars);
    ...
    public Container getContainer(String networkId, String site,
            String contatiner) throws JsonParseException, JsonMappingException,
            IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, networkId);
        ...
        String response = getRepoRestTemplate().getForObject(
                CONTAINER_URL.getUrl(networkId), String.class, vars);
        log.debug("getContainer: " + response);
        Response<Container> c = mapper.readValue(response,
                entryResponseType(Container.class));
        return c.getEntry();
    }
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                CONTAINERS_URL.getUrl(networkId)
                        + generateQueryString(parameters), String.class, vars);
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                MEMBER_URL.getUrl(networkId), String.class, vars);
        log.debug("getMember: " + response);
        Response<Member> m = mapper.readValue(response,
                entryResponseType(Member.class));
        return m.getEntry();
    }
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                MEMBERS_URL.getUrl(network) + generateQueryString(parameters),
                String.class, vars);
    ...
    public Member addMember(String network, String site, String personId,
            Role role) throws JsonParseException, JsonMappingException,
            IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().postForObject(
                MEMBERS_URL.getUrl(network),
                new HttpEntity<Member>(member, headers), String.class, vars);
    ...
    // TODO should this make the additional call to get the updated entity or
    // just move forward
    public void updateMember(String network, String site, String personId,
            Role role) throws RestClientException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        vars.put(TemplateParams.SITE, site);
        ...
        getRepoRestTemplate().put(MEMBER_URL.getUrl(network),
                new HttpEntity<Member>(member, headers), vars);
    ...
    public LegacyPerson createPerson(String networkId, String username,
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().postForObject(
                CREATE_PERSON_URL.getUrl(),
                new HttpEntity<LegacyPerson>(person, headers), String.class,
                vars);
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_URL.getUrl(network), String.class, vars);
        log.debug("getPerson: " + response);
        Response<Person> p = mapper.readValue(response,
                entryResponseType(Person.class));
        return p.getEntry();
    }
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_SITES_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
        log.debug("getSites: " + response);
        Response<Site> s = mapper.readValue(response,
                entryResponseType(Site.class));
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_SITE_URL.getUrl(network), String.class, vars);
        log.debug("getSite: " + response);
        Response<Site> s = mapper.readValue(response,
                entryResponseType(Site.class));
        return s.getEntry();
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().postForObject(
                PEOPLE_FAVORITE_SITES_URL.getUrl(),
                new HttpEntity<Site>(site, headers), String.class, vars);
        log.debug("addFavoriteSite: " + response);
        Response<Site> c = mapper.readValue(response,
                entryResponseType(Site.class));
        return c.getEntry();
    }
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_FAVORITES_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
        log.debug("getFavorites: " + response);
        Response<Favourite> s = mapper.readValue(response,
                entryResponseType(Favourite.class));
        return s.getList();
    }

    public Favourite getFavorite(String network, String person,
            String targetGuid) throws JsonParseException, JsonMappingException,
            IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_FAVORITE_URL.getUrl(network), String.class, vars);
        log.debug("getFavorites: " + response);
        Response<Favourite> s = mapper.readValue(response,
                entryResponseType(Favourite.class));
        return s.getEntry();
    ...
    public Favourite addFavorite(String network, String personId,
            Favourite favourite) throws JsonParseException,
            JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().postForObject(
                PEOPLE_FAVORITES_URL.getUrl(),
                new HttpEntity<Favourite>(favourite, headers), String.class,
                vars);
        log.debug("addFavorite: " + response);
        Response<Favourite> c = mapper.readValue(response,
                entryResponseType(Favourite.class));
        return c.getEntry();
    }

    public void removeFavourite(String network, String personId,
            String targetGuid) throws JsonParseException, JsonMappingException,
            IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
    ...
    public AlfrescoList<SiteMembershipRequest> getPersonSiteMembershipRequests(
            String network, String personId) throws JsonParseException,
            JsonMappingException, IOException
    {
    ...
    public AlfrescoList<SiteMembershipRequest> getPersonSiteMembershipRequests(
            String network, String personId, Map<String, String> parameters)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_SITE_MEMBERSHIP_REQUESTS_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
        log.debug("getPersonSiteMemberhsipRequests: " + response);
        Response<SiteMembershipRequest> s = mapper.readValue(response,
                entryResponseType(SiteMembershipRequest.class));
        return s.getList();
    }

    public SiteMembershipRequest createPersonSiteMembershipRequest(
            String network, String personId,
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().postForObject(
                PEOPLE_SITE_MEMBERSHIP_REQUESTS_URL.getUrl(),
                new HttpEntity<SiteMembershipRequest>(siteMembershipRequest,
                        headers), String.class, vars);
        log.debug("addPersonSiteMembershipRequest: " + response);
        Response<SiteMembershipRequest> c = mapper.readValue(response,
                entryResponseType(SiteMembershipRequest.class));
        return c.getEntry();
    }

    public void cancelPersonSiteMembershipRequest(String network,
            String personId, String siteId) throws JsonParseException,
            JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        getRepoRestTemplate().delete(
                PEOPLE_SITE_MEMBERSHIP_REQUEST_URL.getUrl(network), vars);
        log.debug("cancelPersonSiteMembershipRequest: " + personId + ", "
                + siteId);
    }
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_FAVORITE_SITES_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
    ...
    public Preference getPreference(String network, String person,
            String preference) throws JsonParseException, JsonMappingException,
            IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_PREFERENCE_URL.getUrl(network), String.class, vars);
        log.debug("getPreference: " + response);
        Response<Preference> p = mapper.readValue(response,
                entryResponseType(Preference.class));
        return p.getEntry();
    }
    ...
    public AlfrescoList<Preference> getPreferences(String network,
            String person, Map<String, String> parameters)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_PREFERENCES_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_NETWORK_URL.getUrl(network), String.class, vars);
        log.debug("getNetwork: " + response);
        Response<Network> n = mapper.readValue(response,
                entryResponseType(Network.class));
        return n.getEntry();
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_NETWORKS_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
        log.debug("getNetworks: " + response);
        Response<Network> n = mapper.readValue(response,
                entryResponseType(Network.class));
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                PEOPLE_ACTIVITIES_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
        log.debug("getActivities: " + response);
        Response<Activity> a = mapper.readValue(response,
                entryResponseType(Activity.class));
        return a.getList();
    }

    public Tag getTag(String network, String tag) throws JsonParseException,
            JsonMappingException, IOException
    {
        int count = 0;
        ...
        while (!found)
        {
            for (Iterator<Tag> iterator = response.getEntries().iterator(); iterator
                    .hasNext();)
            {
                ...
                else
                {
                    if (!iterator.hasNext())
                    {
                        ...
                        {
                            parameters.put(Pagination.SKIPCOUNT,
                                    Integer.toString(count = count + MAXITEMS));
    ...
    public AlfrescoList<Tag> getTags(String network) throws JsonParseException,
            JsonMappingException, IOException
    {
    ...
    {
        Map<String, String> vars = Collections.singletonMap(
                TemplateParams.NETWORK, network);

        String response = getRepoRestTemplate().getForObject(
                TAGS_URL.getUrl(network) + generateQueryString(parameters),
                String.class, vars);
        log.debug("getTags: " + response);
        Response<Tag> t = mapper.readValue(response,
                entryResponseType(Tag.class));
        return t.getList();
    }
            ...
            throws RestClientException
    {
        ...
        getRepoRestTemplate().put(TAG_URL.getUrl(network),
                new HttpEntity<Tag>(_tag, headers), vars);
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                NODE_COMMENTS_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
        log.debug("getComments: " + response);
        Response<Comment> c = mapper.readValue(response,
                entryResponseType(Comment.class));
        return c.getList();
    }
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        // String response =
        // getRestTemplate().postForObject(NODE_COMMENTS_URL.getUrl(network),
        // new HttpEntity<Comment>(_comment, headers), String.class, vars);
        String response = getRepoRestTemplate().postForObject(
                NODE_COMMENTS_URL.getUrl(),
                new HttpEntity<Comment>(_comment, headers), String.class, vars);
    ...
    public AlfrescoList<Comment> createComments(String network, String node,
            java.util.List<String> comments) throws JsonParseException,
            JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().postForObject(
                NODE_COMMENTS_URL.getUrl(network),
                new HttpEntity<java.util.List<Comment>>(_comments, headers),
                String.class, vars);
        log.debug("createComments: " + response);
        Response<Comment> createdComments = mapper.readValue(response,
                entryResponseType(Comment.class));
    ...
    public void updateComment(String network, String node, String commentId,
            String comment) throws JsonParseException, JsonMappingException,
            IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        getRepoRestTemplate().put(NODE_COMMENT_URL.getUrl(network),
                new HttpEntity<Comment>(_comment, headers), vars);
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate()
                .getForObject(
                        NODE_TAGS_URL.getUrl(network)
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().postForObject(
                NODE_TAG_URL.getUrl(network),
                new HttpEntity<Tag>(_tag, headers), String.class, vars);
    ...
    public AlfrescoList<Tag> addTagsToNode(String network, String node,
            java.util.List<String> tags) throws JsonParseException,
            JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().postForObject(
                NODE_TAGS_URL.getUrl(network),
                new HttpEntity<java.util.List<Tag>>(_tags, headers),
                String.class, vars);
            ...
            JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                NODE_RATINGS_URL.getUrl(network)
                        + generateQueryString(parameters), String.class, vars);
        log.debug("getNodeRatings: " + response);
        Response<Rating> r = mapper.readValue(response,
                entryResponseType(Rating.class));
        return r.getList();
    }
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().getForObject(
                NODE_RATING_URL.getUrl(network), String.class, vars);
        log.debug("getNodeRatings: " + response);
        Response<Rating> r = mapper.readValue(response,
                entryResponseType(Rating.class));
        return r.getEntry();
    ...
    /*
     * public Rating rateNode(String network, String node, String ratingType,
     * Serializable rating) throws JsonParseException, JsonMappingException,
     * IOException { Map<String, String> vars = new HashMap<String, String>();
     * vars.put(TemplateParams.NETWORK, network); vars.put(TemplateParams.NODE,
     * node);
     * 
     * Rating _rating = new Rating(); _rating.setId(ratingType);
     * _rating.setMyRating(rating);
     * 
     * String response = getRestTemplate().postForObject(NODE_RATINGS_URL, new
     * HttpEntity<Rating>(_rating, headers), String.class, vars);
     * log.debug("rateNode: " + response); Response<Rating> r =
     * mapper.readValue(response, entryResponseType(Rating.class)); return
     * r.getEntry(); }
     */
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().postForObject(
                NODE_RATINGS_URL.getUrl(network),
                new HttpEntity<Rating>(_like, headers), String.class, vars);
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        String response = getRepoRestTemplate().postForObject(
                NODE_RATINGS_URL.getUrl(network),
                new HttpEntity<Rating>(_stars, headers), String.class, vars);
        log.debug("rateNode: " + response);
        Response<Rating> r = mapper.readValue(response,
                entryResponseType(Rating.class));
        return r.getEntry();
    ...
    {
        return mapper.getTypeFactory().constructParametricType(Response.class,
                type);
    }

    public Network getHomeNetwork() throws JsonParseException,
            JsonMappingException, IOException
    {
        Network homeNetwork = null;
        AlfrescoList<Network> response = getNetworks();

        for (Iterator<Network> iterator = response.getEntries().iterator(); iterator
                .hasNext();)
        {
    ...
    public Person getCurrentUser() throws JsonParseException,
            JsonMappingException, IOException
    {
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        throw new OperationNotPermittedException(
                "HTTP OPTIONS Not implemented yet");
        // Map<String, String> vars =
        // Collections.singletonMap(TemplateParams.NETWORK, network);
        // ResponseEntity<String> response =
        // getRestTemplate().exchange("https://api.alfresco.com/{network}/public/alfresco/versions/1/nodes",
        // HttpMethod.OPTIONS,
        // null, String.class, vars);
        // System.out.println("Network Options: " + response.getBody());
        // return mapper.readValue(response.getBody(),
        // entryResponseType(Metadata.class));
    ...
    public UserRegistration registerUser(String email, String firstName,
            String lastName, String password, String source, String sourceUrl)
            throws IOException
    {
        ...
        /*
         * { "registration" : { "email": "joe.bloggs@mingmong",
         * "registrationDate": "2012-11-13T14:08:37.000Z", "id":
         * "activiti$20078", "key": "fe76ca23-3dbb-40ff-a20c-c19b0da46f85" }
         * 
         * }
         */
        String response = getRepoRestTemplate().postForObject(
                REGISTER_USER_URL.getUrl(),
                new HttpEntity<UserRegistrationRequest>(userRegistration,
                        headers), String.class, vars);
        log.debug("registerUser: " + response);
        UserRegistrationResponse r = mapper.readValue(response,
                UserRegistrationResponse.class);
        return r.getUserRegistration();
    }

    public UserActivationResponse activateUser(String id, String key,
            ...
            throws IOException
    {
        ...
        String response = getRepoRestTemplate().postForObject(
                ACTIVATE_USER_URL.getUrl(),
                new HttpEntity<UserActivationRequest>(userActivation, headers),
                String.class, vars);
        log.debug("activateUser: " + response);
        UserActivationResponse r = mapper.readValue(response,
    ...
    private String content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + "<master>"
            + "<document path=\"/alfresco/site-data/components/page.title.site~"
            + "<shortName>"
            + "~dashboard.xml\">"
            + "<component>"
            + "<guid>page.title.site~"
            + "<shortName>"
            + "~dashboard</guid>"
            + "<scope>page</scope>"
            ...
            + "</component>"
            + "</document>"
            + "<document path=\"/alfresco/site-data/components/page.navigation.site~"
            + "<shortName>"
            + "~dashboard.xml\">"
            + "<component>"
            + "      <guid>page.navigation.site~"
            + "<shortName>"
            + "~dashboard</guid> "
            + "     <scope>page</scope> "
            ...
            + "   </component>"
            + " </document>"
            + " <document path=\"/alfresco/site-data/components/page.full-width-dashlet.site~"
            + "<shortName>"
            + "~dashboard.xml\">"
            + "   <component>"
            + "     <guid>page.full-width-dashlet.site~"
            + "<shortName>"
            + "~dashboard</guid>"
            + "     <scope>page</scope>"
            ...
            + "   </component>"
            + " </document>"
            + " <document path=\"/alfresco/site-data/components/page.component-1-1.site~"
            + "<shortName>"
            + "~dashboard.xml\">"
            + "		    <component>"
            + "	      <guid>page.component-1-1.site~"
            + "<shortName>"
            + "~dashboard</guid>"
            + "	      <scope>page</scope>"
            ...
            + "	    </component>"
            + "	  </document>"
            + "	  <document path=\"/alfresco/site-data/components/page.component-2-1.site~"
            + "<shortName>"
            + "~dashboard.xml\">"
            + "	    <component>"
            + "	      <guid>page.component-2-1.site~"
            + "<shortName>"
            + "~dashboard</guid>"
            + "	      <scope>page</scope>"
            ...
            + "	    </component>"
            + "	  </document>"
            + "	  <document path=\"/alfresco/site-data/components/page.component-2-2.site~"
            + "<shortName>"
            + "~dashboard.xml\">"
            + "	    <component>"
            + "	      <guid>page.component-2-2.site~"
            + "<shortName>"
            + "~dashboard</guid>"
            + "	      <scope>page</scope>"
            ...
            + "	    </component>"
            + "	  </document>"
            + "	  <document path=\"/alfresco/site-data/pages/site/"
            + "<shortName>"
            + "/dashboard.xml\">"
            + "	    <page>"
            ...
            + "	      </properties>" + "	    </page>" + "	  </document>"
            + "	</master>";

    public LegacySite createSite(String networkId, String siteId,
            String sitePreset, String title, String description,
            Visibility visibility) throws IOException
    {
        ...
        String response = rest.postForObject(CREATE_SITE_URL.getUrl(networkId),
                new HttpEntity<LegacySite>(_site, headers), String.class, vars);
        ...
        response = rest.postForObject(ADM_CREATE_MULTI_URL.getUrl(networkId)
                + generateQueryString(parameters), post, String.class, vars);

        vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, networkId);
        String url = ACCESS_DOC_LIB_URL.getUrl(networkId).replace("<siteId>",
                siteId);
        try
        {
    ...
    public ObjectId createRelationship(String networkId, String sourceObjectId,
    ...
    public java.util.List<Tree<FileableCmisObject>> getDescendants(
            String networkId, String folderId, Integer depth,
            ...
            Set<String> propertyFilter, Boolean includePolicies)
    {
        ...
        {
            Folder f = (Folder) o;
            java.util.List<Tree<FileableCmisObject>> ret = f.getDescendants(
                    depth, cmisOperationContext);
            return ret;
        }
        else
        {
    ...
    public java.util.List<Tree<FileableCmisObject>> getFolderTree(
            String networkId, String folderId, Integer depth,
            IncludeRelationships includeRelationships, Boolean includeAcls,
            Set<String> propertyFilter, Boolean includePolicies)
    {
        ...
        {
            Folder f = (Folder) o;
            java.util.List<Tree<FileableCmisObject>> ret = f.getFolderTree(
                    depth, cmisOperationContext);
            return ret;
        }
        else
    ...
    // GetMethod(httpProvider.getFullAlfrescoUrlForPath(MessageFormat.format(URL,
    // networkId)));
    //
    // HttpResponse httpResponse =
    // authenticatedHttp.executeHttpMethodAuthenticated(getMethod, username,
    // getCallback("Error getting people"));
    ...
    private String generateQueryString(Map<String, String> parameters)
    {
        ...
        if (parameters != null && parameters.size() > 0)
        {
            ...
            Iterator<java.util.Map.Entry<String, String>> entries = parameters
                    .entrySet().iterator();
            while (entries.hasNext())
            {
                java.util.Map.Entry<String, String> thisEntry = entries.next();
                queryString.append(thisEntry.getKey()).append("=")
            ...
            throws JsonParseException, JsonMappingException, IOException
    {
        ...
        // new HttpEntity<Comment>(_comment, headers), String.class, vars);
        String response = getRepoRestTemplate().postForObject(
                SUBSCRIBERS_PATH.getUrl(),
                new HttpEntity<Subscriber>(subscriber, headers), String.class,
                vars);
        log.debug("createSubscriber: " + response);
        Response<Subscriber> c = mapper.readValue(response,
                entryResponseType(Subscriber.class));
        Subscriber ret = c.getEntry();
        return ret;
    }

    public Subscription createSubscription(String network, String subscriberId,
            SubscriptionType subscriptionType, String targetPath)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
        ...
        String response = getRepoRestTemplate().postForObject(
                SUBSCRIPTIONS_PATH.getUrl(),
                new HttpEntity<SubscriptionRequest>(subscriptionRequest,
                        headers), String.class, vars);
        log.debug("createSubscription: " + response);
        Response<Subscription> c = mapper.readValue(response,
                entryResponseType(Subscription.class));
    ...
    public void removeSubscription(String network, String subscriberId,
            String subscriptionId) throws JsonParseException,
            JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, network);
    ...
    public StartSyncResponse startSync(StartSyncRequest req, String networkId,
            String subscriberId, String subscriptionsQuery)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, networkId);
        ...
        String response = getSyncRestTemplate().postForObject(
                SYNCS_PATH.getUrl(networkId),
                new HttpEntity<StartSyncRequest>(req, headers), String.class,
                vars);
        log.debug("startSync: " + response);
        StartSyncResponse ret = mapper.readValue(response,
                StartSyncResponse.class);
        return ret;
    }

    public String startSyncRaw(StartSyncRequest req, String networkId,
            String subscriberId, String subscriptionsQuery)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
    ...
    public GetSyncChangesResponse getSync(String networkId, String subscriberId,
            String subscriptionsQuery, String syncId)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, networkId);
        ...
        String response = getSyncRestTemplate().getForObject(
                SYNC_PATH.getUrl(networkId), String.class, vars);
        log.debug("getSync: " + response);
        GetSyncChangesResponse ret = mapper.readValue(response,
                GetSyncChangesResponse.class);
        return ret;
    }

    public String getSyncRaw(String networkId, String subscriberId,
            String subscriptionsQuery, String syncId)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
    ...
    public void endSync(String networkId, String subscriberId,
            String subscriptionsQuery, String syncId)
            throws JsonParseException, JsonMappingException, IOException
    {
        Map<String, String> vars = new HashMap<String, String>();
    ...
    public String metrics(String networkId)
    {
        Map<String, String> vars = new HashMap<String, String>();
        vars.put(TemplateParams.NETWORK, networkId);

        String response = getSyncRestTemplate().getForObject(
                METRICS.getUrl(networkId), String.class, vars);
        return response;
    }
    ...
    protected abstract class AbstractPublicApiNetworkUrl implements
            PublicApiUrl
    {
    ...
    protected class PublicApiNetworkUrl extends AbstractPublicApiNetworkUrl
    {
        ...
        {
            return baseUrl + publicApiServletName + "/"
                    + url.replaceAll("\\{network\\}", networkId);
        }
    }
