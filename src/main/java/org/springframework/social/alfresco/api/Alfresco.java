...
public interface Alfresco
{
    ...
    public static CMISEndpoint cmisAtom10Endpoint = new CMISEndpoint(
            BindingType.ATOMPUB, CmisVersion.CMIS_1_0);
    public static CMISEndpoint cmisAtom11Endpoint = new CMISEndpoint(
            BindingType.ATOMPUB, CmisVersion.CMIS_1_0);
    public static CMISEndpoint cmisBrowser11Endpoint = new CMISEndpoint(
            BindingType.BROWSER, CmisVersion.CMIS_1_1);
    ...
    public Network getNetwork(String network) throws JsonParseException,
    ...
    public Site getSite(String site, String network) throws JsonParseException,
            JsonMappingException, IOException;
    ...
    LegacyPerson createPerson(String network, String username,
    ...
    public AlfrescoList<Comment> createComments(String network, String node,
            List<String> comments) throws JsonParseException,
            JsonMappingException, IOException;
    ...
    public AlfrescoList<Tag> addTagsToNode(String network, String node,
            List<String> tags) throws JsonParseException, JsonMappingException,
            IOException;
    ...
    public LegacySite createSite(String network, String siteId,
    ...
    public void removeFavourite(String network, String personId,
            String favouriteId) throws JsonParseException,
            JsonMappingException, IOException;
    ...
    public AlfrescoList<SiteMembershipRequest> getPersonSiteMembershipRequests(
            String network, String person, Map<String, String> parameters)
            throws JsonParseException, JsonMappingException, IOException;
    ...
    Subscription createSubscription(String network, String subscriberId,
    ...
    void removeSubscription(String network, String subscriberId,
            String subscriptionId) throws JsonParseException,
            JsonMappingException, IOException;

    StartSyncResponse startSync(StartSyncRequest req, String networkId,
            String subscriberId, String subscriptionsQuery)
            throws JsonParseException, JsonMappingException, IOException;

    String startSyncRaw(StartSyncRequest req, String networkId,
            String subscriberId, String subscriptionsQuery)
            throws JsonParseException, JsonMappingException, IOException;

    GetSyncChangesResponse getSync(String networkId, String subscriberId,
            String subscriptionsQuery, String syncId)
            throws JsonParseException, JsonMappingException, IOException;

    String getSyncRaw(String networkId, String subscriberId,
            String subscriptionsQuery, String syncId)
            throws JsonParseException, JsonMappingException, IOException;

    void endSync(String networkId, String subscriberId,
            String subscriptionsQuery, String syncId)
            throws JsonParseException, JsonMappingException, IOException;

    String metrics(String networkId);
