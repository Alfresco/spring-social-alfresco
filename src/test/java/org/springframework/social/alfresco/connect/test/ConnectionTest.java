...
public class ConnectionTest
{
    ...
    {       
        ...
        AccessGrant accessGrant = connectionFactory.getOAuthOperations().exchangeForAccess(
                    accessToken, REDIRECT_URI, null);

        System.out.println("Access: " + accessGrant.getAccessToken() + " Refresh: "
                    + accessGrant.getRefreshToken() + " Scope: " + accessGrant.getScope()
                    + " expires: " + accessGrant.getExpireTime());
